angular.module('myApp.pharmacyManagerRecipesInProgress', ['ngRoute', 'ui.bootstrap.progressbar'])
    ...
    .controller('PharmacyManagerRecipesInProgressController', ['$scope', '$modal', '$log', function ($scope, $modal, $log) {
        $scope.persons = [
            {
                id: 1,
